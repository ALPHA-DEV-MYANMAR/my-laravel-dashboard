                    ...
                    <div class="sign-in-form ">
                        ...
                        <form action="{{ route('register') }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg rounded" name="name">
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control form-control-lg rounded" name="email">
                                @error('email')
                                <span class="text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control form-control-lg rounded" name="password_confirmation">
                            </div>
